...
/**
 * 메인화면 (상세 버전). 이번 주 숙제 제출용.
 *
 * 논의 필요: 기존 ui/home/HomeScreen.kt(단순 버전, "여행하기" 버튼만 있는 버전)와
 * 같은 화면·같은 경로에서 겹침. 둘 중 어느 걸 기반으로 갈지(혹은 합칠지) 정하기
 * 전까지는 이 파일 그대로 덮어쓰지 말고 이름 바꿔서(HomeScreenDetailed.kt) 비교할 것.
 *
 * 의도:
        ...
        Column(
            ...
            Row(
                ...
                SegmentedToggle(
                    ...
                    onSelectedChange = { selectedTabIndex = it }
                )
            }
